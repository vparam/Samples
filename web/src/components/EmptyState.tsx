...
export default function EmptyState({ query, onClear, onSuggestionSelect }: EmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-10 px-4 text-center bg-surface rounded-[20px] border-2 border-dashed border-border/80">
      ...
      <h4 className="text-[18px] font-bold text-[#0F172A] mb-2">No results found</h4>
      <p className="text-[14px] text-[#334155] max-w-[260px] leading-relaxed mb-6 font-medium">
        We couldn't find any documents matching &ldquo;{query}&rdquo; in the repository.
      </p>
